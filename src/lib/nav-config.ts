...
export const navConfig: NavItem[] = [
  ...
  { id: 'crop-recommendations', href: '/crop-recommendations', icon: Sprout, label: 'Crop Advisory' },
  { id: 'pest-detection', href: '/pest-detection', icon: Bug, label: 'Pest Detection' },
  { id: 'irrigation-planner', href: '/irrigation-planner', icon: Droplets, label: 'Irrigation Planner' },
  { id: 'yield-prediction', href: '/yield-prediction', icon: TrendingUp, label: 'Yield Prediction' },
