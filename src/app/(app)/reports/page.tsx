                    ...
                    <CardContent>
                        <ChartContainer config={chartConfig} className="min-h-[250px] w-full">
                            <LineChart accessibilityLayer data={profitData} margin={{ left: 12, right: 12, top: 5, bottom: 5 }}>
                                ...
                                />
                                <ChartTooltip cursor={false} content={<ChartTooltipContent indicator="line" formatter={(value) => new Intl.NumberFormat('en-IN', { maximumFractionDigits: 0 }).format(Number(value))} />} />
                                <Line
                                    dataKey="profit"
                                    type="monotone"
